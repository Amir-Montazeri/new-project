...
function Register({ isLoading, setIsLoading }) {
	...
	async function submitHandler(e) {
		...
		if (statusLevel === 1) {
			axios
				.post(`${base_api_url}/auth/send_otp/`, {
	...
	function confirmedPassHandler(e) {
		setInfo({
			...info,
			confirmedPass: e.target.value.trim(),
		});
	}
	...
	return (
		<div
			className="min-vh-100 py-3 d-flex justify-content-center align-items-center"
